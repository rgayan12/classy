<?php
 ...
 Route::get('school/{company}', 'HomePageController@company')->name('company');
Route::get('/auditions', 'HomePageController@audition')->name('audition');
...
Route::group(['middleware' => ['auth'], 'prefix' => 'admin', 'as' => 'admin.'], function () {
    ...
    Route::resource('auditions', 'Admin\AuditionsController');
