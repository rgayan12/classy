		...
		<div class="row">
			<div class="col-md-12">
				...
				<div class="content-block">
					<h1>Search & Apply for Performing arts school & college. </h1>
					<p>Join to create your application in one place<br> Apply for all schools and colleges</p>
				</div>
				<!-- Advance Search -->
		...
		<div class="row">
			<div class="col-12">
				...
				<div class="section-title">
					...
					<p>Increase your chance and manage the your application from a single place.</p>
				</div>
                <div class="row">
                        ...
                        <div class="col-lg-3 offset-lg-0 col-md-5 offset-md-1 col-sm-6 col-6">
                            <div class="category-block">
                                ...
                                <ul class="category-list">
                                    @foreach ( $category_all->companies->shuffle()->take(5) as $singleCompany)
